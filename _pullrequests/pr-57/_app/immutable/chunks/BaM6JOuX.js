...
import { p as parse_route_id, e as exec, a as assets, b as base } from "./Du_gMTTO.js";
...
async function start(_app, _target, hydrate) {
  if (globalThis.__sveltekit_b4itoz?.data) {
    globalThis.__sveltekit_b4itoz.data;
  }

...
var base = globalThis.__sveltekit_1ymevmj?.base ?? "/cigale/_pullrequests/pr-202";
var assets = globalThis.__sveltekit_1ymevmj?.assets ?? base ?? "";
//#endregion
...
async function start(_app, _target, hydrate) {
	if (globalThis.__sveltekit_1ymevmj.data) {
		const { q = {}, p = {}, l = {}, f = {} } = globalThis.__sveltekit_1ymevmj.data;

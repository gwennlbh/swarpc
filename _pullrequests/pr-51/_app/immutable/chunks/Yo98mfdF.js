...
import { p as parse_route_id, e as exec, a as assets, b as base } from "./3g0Ww7Bv.js";
...
async function start(_app, _target, hydrate) {
  if (globalThis.__sveltekit_ovsgka?.data) {
    globalThis.__sveltekit_ovsgka.data;
  }

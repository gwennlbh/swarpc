...
import { p as parse_route_id, e as exec, a as assets, b as base } from "./7C3y3jBp.js";
...
async function start(_app, _target, hydrate) {
  if (globalThis.__sveltekit_1a9pkom?.data) {
    globalThis.__sveltekit_1a9pkom.data;
  }

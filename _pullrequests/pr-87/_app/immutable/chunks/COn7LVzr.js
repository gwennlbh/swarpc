...
import { p as parse_route_id, e as exec, a as assets, b as base } from "./t4yAL7TC.js";
...
async function start(_app, _target, hydrate) {
  if (globalThis.__sveltekit_1dvsb3p?.data) {
    globalThis.__sveltekit_1dvsb3p.data;
  }

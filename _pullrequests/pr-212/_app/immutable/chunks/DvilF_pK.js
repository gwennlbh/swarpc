...
var base = globalThis.__sveltekit_1lif2fm?.base ?? "/cigale/_pullrequests/pr-212";
var assets = globalThis.__sveltekit_1lif2fm?.assets ?? base ?? "";
//#endregion
...
async function start(_app, _target, hydrate) {
	if (globalThis.__sveltekit_1lif2fm.data) {
		const { q = {}, p = {}, l = {}, f = {} } = globalThis.__sveltekit_1lif2fm.data;

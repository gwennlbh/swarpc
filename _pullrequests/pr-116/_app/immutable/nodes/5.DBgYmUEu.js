import { f as from_html, a as append, t as text, c as comment } from "../chunks/C0nXEaUT.js";
import { Q as push, s as sibling, d as set, g as get, i as user_derived, e as state, R as pop, h as child, r as reset, t as template_effect, f as first_child } from "../chunks/CM8fHnnq.js";
import { d as delegate, s as set_text } from "../chunks/jKaa8Eec.js";
import { i as if_block } from "../chunks/DqQ_XDr3.js";
import { r as remove_input_defaults } from "../chunks/8BK6Uc4j.js";
import { b as bind_value } from "../chunks/CP2ni_U9.js";
const entries = () => [
  { worker: "service" },
  { worker: "dedicated" },
  { worker: "shared" }
...
var root = from_html(`<div><h2>Once Mode Tests</h2> <section class="svelte-1erqe5"><h3>Test 1: .once() - cancels previous call of same method</h3> <input type="number" aria-label="input a for test 1"/> * <input type="number" aria-label="input b for test 1"/> = <button aria-label="compute once test 1"><!></button></section> <section class="svelte-1erqe5"><h3>Test 2: .onceBy(key) - cancels previous call with same key</h3> <input type="number" aria-label="input a for test 2"/> * <input type="number" aria-label="input b for test 2"/> = <button aria-label="compute onceby foo test 2"><!></button></section> <section class="svelte-1erqe5"><h3>Test 3: global onceBy - cancels any call with same global key</h3> <input type="number" aria-label="input a for test 3"/> * <input type="number" aria-label="input b for test 3"/> = <button aria-label="compute global onceby test 3"><!></button></section></div>`);

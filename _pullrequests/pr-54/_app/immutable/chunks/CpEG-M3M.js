...
import { p as parse_route_id, e as exec, a as assets, b as base } from "./DTiHCvSs.js";
...
async function start(_app, _target, hydrate) {
  if (globalThis.__sveltekit_nbr5y0?.data) {
    globalThis.__sveltekit_nbr5y0.data;
  }

...
import { p as parse_route_id, e as exec, a as assets, b as base } from "./zc_Kqz2E.js";
...
async function start(_app, _target, hydrate) {
  if (globalThis.__sveltekit_7rcivk?.data) {
    globalThis.__sveltekit_7rcivk.data;
  }

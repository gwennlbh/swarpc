...
var base = globalThis.__sveltekit_z3zkmp?.base ?? "/cigale/_pullrequests/pr-211";
var assets = globalThis.__sveltekit_z3zkmp?.assets ?? base ?? "";
//#endregion
...
async function start(_app, _target, hydrate) {
	if (globalThis.__sveltekit_z3zkmp.data) {
		const { q = {}, p = {}, l = {}, f = {} } = globalThis.__sveltekit_z3zkmp.data;

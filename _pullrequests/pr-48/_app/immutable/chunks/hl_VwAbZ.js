...
import { p as parse_route_id, e as exec, a as assets, b as base } from "./BMywcV36.js";
...
async function start(_app, _target, hydrate) {
  if (globalThis.__sveltekit_1se4v1s.data) {
    globalThis.__sveltekit_1se4v1s?.data;
  }

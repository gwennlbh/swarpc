...
import { p as parse_route_id, e as exec, a as assets, b as base } from "./ByaCj-y8.js";
...
async function start(_app, _target, hydrate) {
  if (globalThis.__sveltekit_1b1fm5w.data) {
    globalThis.__sveltekit_1b1fm5w?.data;
  }

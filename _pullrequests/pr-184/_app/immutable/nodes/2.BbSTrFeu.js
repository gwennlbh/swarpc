import { K as __exportAll } from "../chunks/DGs0AZwM.js";
import { n as HttpError } from "../chunks/BB6gmSoS.js";
import { t as Layout } from "../chunks/DsMFQLsf.js";
import { t as Client } from "../chunks/C1eDn08u.js";
...
ark.declare;
//#endregion
//#region src/lib/procedures.ts
var procedures = { multiply: {
	input: type({
		a: "number",
		b: "number"
	}),
...
//#endregion
//#region src/routes/[worker]/+layout.ts
...
async function load({ params, url: { searchParams } }) {
	...
	switch (params.worker) {
		case "shared": return { swarpc: Client(procedures, {
			worker: WorkerWrapper$1,
			nodes: nodesCount
		}) };
		case "dedicated": return { swarpc: Client(procedures, {
		...
		case "service":
			...
			return { swarpc: Client(procedures) };
	}
	error(400, "Invalid worker type");
}
//#endregion
export { Layout as component, _layout_exports as universal };

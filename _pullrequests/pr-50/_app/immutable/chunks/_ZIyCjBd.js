...
import { p as parse_route_id, e as exec, a as assets, b as base } from "./Dl1jULBp.js";
...
async function start(_app, _target, hydrate) {
  if (globalThis.__sveltekit_mzxxfh.data) {
    globalThis.__sveltekit_mzxxfh?.data;
  }

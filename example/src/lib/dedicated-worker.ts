...
import { sharedProcedures } from "./shared-procedures";

// Create server instance with shared procedures
const swarpc = Server(sharedProcedures);

// Implement shared procedures (same implementations as service worker)
